...
obj1.1yr <- read.csv('Analysis Data/Obj1_1yr_Pts.csv')
obj1.1yr <- left_join(obj1.1yr, obj1, by="UniqueIdentifier") %>% select(-X)
```

table 1 for primary objective population
\pagebreak
```{r echo=FALSE, warning=FALSE}
obj1.1yr %>% select(c('KOH.cat','age','Sex.long','avg.bmi','HTN','PreDM','T2DM','both','ClinicLocation','No.column.name','IncomeLevel','BLACERISK')) %>%
