...
kable(obj1_res) %>% pack_rows("a1c_longitudinal", 1, 5) %>% pack_rows("sbp_longitudinal", 6, 10)
...
rownames(obj2_res) = c("months:Marsh","Marsh", "months", "months:Marsh ","Marsh ", "months ")
colnames(obj2_res)[4] = "p-value"

kable(obj2_res) %>% pack_rows("a1c_longitudinal", 1, 3) %>% pack_rows("sbp_longitudinal", 4, 6)
```
